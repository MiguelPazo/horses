...
<div class="form-group">
    ...
    {!! Form::text('owner_name', ($oOwner != null) ? $oOwner->names . ', ' . $oOwner->lastnames : null, ['class' =>
    'form-control namewlast complete_agents', 'maxlength' => 130]) !!}
</div>
<div class="form-group">
    {!! Form::label('breeder_name', 'Criador:') !!}
    {!! Form::text('breeder_name', ($oBreeder != null) ? $oBreeder->names . ', ' . $oBreeder->lastnames : null, ['class'
    =>
    'form-control namewlast complete_agents', 'maxlength' => 50]) !!}
</div>
<div class="form-group">
    {!! Form::label('prefix', 'Prefijo:') !!}
    {!! Form::text('prefix', ($oBreeder != null) ? $oBreeder->prefix : null, ['class' => 'form-control', 'maxlength' =>
    50]) !!}
</div>
<div class="form-group">
    {!! Form::label('dad_name', 'Padre:') !!}
    {!! Form::text('dad_name', ($oDad != null) ? $oDad->name : null, ['class' => 'form-control', 'maxlength' => 45]) !!}
</div>
<div class="form-group">
    {!! Form::label('mom_name', 'Madre:') !!}
    {!! Form::text('mom_name', ($oMom != null) ? $oMom->name : null, ['class' => 'form-control', 'maxlength' => 45]) !!}
</div>